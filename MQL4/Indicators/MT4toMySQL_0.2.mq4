...
extern string host     = "db-mysql-nyc3-17788-do-user-11605945-0.b.db.ondigitalocean.com";
extern int    port     = 25060;
extern int    socket   = 0;
extern string user     = "nguemechieu";
extern string password = "AVNS_XMIG88cnUhkOjtMosC0";
extern string dbName   = "tradeadviser";
...
Comment("Connecting...");
        ...
        if (DB == -1)
        {
            ...
            Comment("Connection to MySQL database failed! Error: " + MySqlErrorDescription);
        }
        else
        {Comment("Connected! DB_ID#", DB);
