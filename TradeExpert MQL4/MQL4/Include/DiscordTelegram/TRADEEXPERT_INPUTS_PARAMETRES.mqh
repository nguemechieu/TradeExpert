...
extern string     conctact          = "===== For enquiries Contact 3022764379 on WhatApps====="; //====Contact NGUEMECHIEU@LIVE.COM=====
extern int        MT4account        = 1234567;     // MT4 Number/ Pascode

extern  string  menu1="========= SmartBot Configuration  ============";


input Platform InpLatform=TELEGRAM;// SELECT SIGNAL PLATFORM

extern Answer      telegram        = Yes; //Use Bot
input ENUM_UPDATE_MODE InpUpdateMode=UPDATE_SLOW ;//UPDATE MODE
...
extern string     InpTocken   = "2032573404:AAHe_qgM10wqo4z0o4lXKQe1O8A3gw-t0q4";//API TOCKEN
...
input const string Indicators_list="ATR ; Momentum; RSI ; ZigZag_Pointer; ";//Indicators list (Enter Y)
...
input indicatorss inpInd0                        = POSITION5 ;              // Entry Indicator 1
...
input indicatorss inpInd1                        = POSITION1;               // Entry Indicator 2
...
input indicatorss inpInd1Ex                     = POSITION3;                 // Exit Indicator 2
...
input indicatorss inpInd2                       = POSITION2;              // Entry Indicator 3
...
input indicatorss inpInd2Ex                     = POSITION3;               // Exit Indicator 3
...
input indicatorss inpInd3                        = POSITION4;                // Entry Indicator 4
...
input indicatorss inpInd3Ex                     = POSITION2;                  // Exit Indicator 4
