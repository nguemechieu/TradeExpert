...
#define CLIENT_BG_WIDTH (700)
 ...
 int ExitSignal3[100] , ExitSignal2[100], ExitSignal1[100], ExitSignal0[100];   
...
#define JOB "7022"
#define EPOCH D'2022.01.01 00:00'
#define OBJPFX JOB"_"
...
string sTradeSymbols = InpUsedSymbols;
int NumOfSymbols=StringSplit(_split,u_sep,array_used_symbols);
